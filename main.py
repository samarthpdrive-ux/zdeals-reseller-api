...
Legacy compatibility:
  /api/reseller?action=products|balance|orders|order
"""
...
BACKEND_TIMEOUT = (3.0, 5.0)  # connect timeout, read timeout
...
class ProductCache:
    """Product cache keyed by a hash of the reseller API key."""
...
class GatewayHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, _format: str, *_args: object) -> None:
        # Never log client headers, API keys, or request bodies.
        return
    ...
    def get_api_key(self) -> str:
        ...
        if authorization:
            ...
            # Existing compatibility support.
    ...
    def send_backend_response(
        ...
        # Do not expose an upstream Location header or redirect clients.
        if (
    ...
    def validated_order_body(self, body: bytes) -> bytes | None:
        ...
        # Preserve normal modern JSON exactly.  Convert the documented
        # legacy field names only when necessary.
        if (
            "service_id" in data
